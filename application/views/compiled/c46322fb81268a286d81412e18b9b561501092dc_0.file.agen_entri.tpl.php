<?php
/* Smarty version 3.1.30, created on 2018-01-04 19:42:10
  from "D:\www\secureproperty\application\modules\homepage\views\agen_entri.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a4e75822bf238_34270204',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c46322fb81268a286d81412e18b9b561501092dc' => 
    array (
      0 => 'D:\\www\\secureproperty\\application\\modules\\homepage\\views\\agen_entri.tpl',
      1 => 1515091328,
      2 => 'file',
    ),
  ),
...
function content_5a4e75822bf238_34270204 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="row">
	<div class="col-md-12">
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="email" name="agen_initial_name" class="form-control" id="agen_initial_name">
                  </div>
                </div>
            </div>
...
$(function(){
  ...
  $('#agen_initial_name').keypress(function(){
    if ($('#agen_initial_name').val().length >= 3) {
      $.ajax({
          type: "POST",
          url: "homepage/cekWebName",
          dataType: "json",
